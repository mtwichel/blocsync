---
title: 🔄 SyncedBloc
description: Learn how to use SyncedBloc to sync bloc states across devices
---

Using `SyncedBloc` is incredibly simple - just follow these three steps to get
your bloc states syncing across devices!
...
:::tip[Selective Syncing] If you don't want certain parts of your state to be
...
Your states will now automatically sync across devices! No additional setup
required - `SyncedBloc` handles all the synchronization logic behind the scenes.
...
Your bloc works exactly like a regular bloc, but with the added superpower of
