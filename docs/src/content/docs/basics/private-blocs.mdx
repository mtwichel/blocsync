...
:::caution[Authentication Required] Private blocs will not sync until the user
is authenticated. Make sure your authentication flow is complete before creating
private blocs. For information on setting up authentication, see
[Firebase Auth](/authentication/firebase-auth) or
[Supabase Auth](/authentication/supabase-auth). :::
...
:::note Blocs can be private **and** partitioned. For more information on
partitioned blocs, see [Partitioned Blocs](/basics/partitioned-blocs). :::
