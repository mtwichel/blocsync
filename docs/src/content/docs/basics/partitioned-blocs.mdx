...
description: Create multiple isolated state instances for the same bloc
---

In most application, it's common to want to create multiple _partitions_ to have
multiple states for the same bloc. For example:
...
private blocs, see [Private Blocs](/basics/private-blocs) :::
